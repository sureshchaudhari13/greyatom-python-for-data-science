...
print ("message_1 :",message_1," message_2 :",message_2)
...
print("message_4",message_4,"message_5",message_5)
...
#l3=list(set(l1)-set(l2))  or below we can use to get diff between 2 lists.
